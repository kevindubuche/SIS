...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><b>I.F.A | </b>ETUDIANT(E)</span>
    </a>
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="{{asset('student_images/'.$student->image)}}" class="user-image" alt="User Image">
              <span class="hidden-xs">{{$student->first_name}} {{$student->last_name}} </span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="{{asset('student_images/'.$student->image)}}" class="img-circle" alt="User Image">

                <p>
                  {{$student->first_name}} {{$student->last_name}}  - Web Developer
