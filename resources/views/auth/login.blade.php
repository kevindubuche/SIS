    ...
    <div class="login-box-body" style="  box-shadow: 5px 10px #f5eded;">
        ...
        <form method="post" action="{{ url('/login') }}">
            ...
            <div class="form-group has-feedback {{ $errors->has('email') ? ' has-error' : '' }}">
                <input type="email" class="form-control" name="email" value="{{ old('email') }}" placeholder="Email" style="border-radius:25px;" required>
            ...
            <div class="form-group has-feedback{{ $errors->has('password') ? ' has-error' : '' }}">
                <input type="password" class="form-control" placeholder="Mot de passe" name="password" style="border-radius:25px;" required>
